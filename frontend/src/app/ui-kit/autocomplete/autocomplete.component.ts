...
@Component({
    ...
    imports: [RouterLink, MatCardModule, MatButtonModule, MatMenuModule, MatFormFieldModule, MatInputModule, ReactiveFormsModule, FormsModule, MatAutocompleteModule, AutocompleteOverviewComponent, DsAutocompleteComponent, FilterAutocompleteComponent, OgAutocompleteComponent, PiAutocompleteComponent, SimpleAutocompleteComponent, AsyncPipe],
